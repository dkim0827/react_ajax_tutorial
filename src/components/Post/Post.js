...
/*
To give animation properly when post moves to next or previous
need to
everytime when gets props, need to update with state, render value in the state
rather than
passing props as it is.
